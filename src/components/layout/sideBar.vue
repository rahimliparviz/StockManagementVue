  ...
  <nav>
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <router-link class="sidebar-brand d-flex align-items-center justify-content-center" to="/">
        ...
        <div class="sidebar-brand-text mx-3">Inventory System 
      ...
      <li class="nav-item">
        ...
        >
          <div class="bg-white py-2 collapse-inner rounded">
            <router-link v-if="isAdmin" class="collapse-item" to="/add-employee">Add Employee</router-link>
      ...
      <li class="nav-item">
        <a
          ...
          href="#"
          data-toggle="collapse"
          data-target="#collapseExpence"
          aria-expanded="true"
          aria-controls="collapseExpence"
        >
...
export default {
  data() {
    return {
      ...
      isAdmin:this.$store.getters.userType == 'admin'
    };
  }
};
</script>
